...
class RequestTest extends TestCase
{
    ...
    {
        $this->assertEquals(Request::getContext(), 'GET /blah/blah.php');
    }

    public function testGetCurrentUrl()
    {
        $this->assertEquals(Request::getCurrentUrl(), 'http://example.com/blah/blah.php?some=param');
    }

    public function testRequestIp()
    {
        $this->assertEquals(Request::getRequestIp(), '123.45.67.8');
    }
}
